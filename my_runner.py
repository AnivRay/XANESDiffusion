...
xanesCondGenCommand = "CUDA_VISIBLE_DEVICES=1 python eval_conditional_xanes.py --generators_path outputs/fe_xanes_cond_final"
...
kNNCommand = "CUDA_VISIBLE_DEVICES=0 python eval_knn_baseline.py --no-cuda"
